...
function toggleAudio() {
    if (domElements.audioPlayer.paused) {
        ...
        domElements.audioPlayer.play()
            ...
            .catch(err => {
                console.log("오디오 재생 인터랙션 방어:", err);
                isPlayRequested = false;
                showPlayIcon();
            });
    } else {
...
domElements.btnRestart.addEventListener('click', resetApplication);
