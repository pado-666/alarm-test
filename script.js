...
const resultMatrix = {
    ...
    homecoming: {
        ...
        emoji: "🏡",
        desc: "일반적인 수면 흐름을 유지하셨으나 다소 잔여 피로가 느껴지는 상태입니다. 중간 주파수 대역이 편안하게 레이어드된 멜로디 음원입니다. 기상 스트레스 호름몬인 코르티솔의 분비를 급격히 촉진하지 않으면서 부드러운 하모니를 통해 각성을 돕습니다."
    },
    galaxyBells: {
        name: "Galaxy Bells",
